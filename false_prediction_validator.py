...
def main():
    ...
    with open("test.gff3", "w") as out:
        out.write(f"# There were {motif_count} transferred predictions with the motif found\n")
    ...
    # status
    print(f"There were {motif_count} transferred predictions with the motif found")
